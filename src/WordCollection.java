...
public class WordCollection {
  ...
  private void addWord(String a_line) throws IOException {
    ...
    private WordCollection getWordCollectionforEnglishTheme(String a_english_theme) {
    ...
    private WordCollection getSomeRandomWords(int some_number) {
    ...
    private ArrayList<String> getEnglishInEnglishCollection() {
    ...
    public static void main(String args[]){
        System.out.println("Starting Program");
         WordCollection collection = new WordCollection("words_2.txt");
